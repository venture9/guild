<div class="container costumer-dashboard-container">
	...
	<h5> costumer Project - <?php echo $costumer_project; ?></h5>
	...
	<div class="right-container col-md-9">
		...
		<div id="costumer-info" class="desinger-block active">
			<h3> Your Profile </h3>
			<form action="<?php echo base_url().'costumer/add_costumer'; ?>" method="post" id="costumer-info-form">
				<h2>Current Project Information</h2>
				<p>
					<label for="catalog_name">Project Name</label> <br />
					<input type="text" name="project_name" size="50" value="<?php echo $costumer_project; ?>" />
				</p>
